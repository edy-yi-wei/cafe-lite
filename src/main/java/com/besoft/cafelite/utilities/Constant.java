...
public class Constant {
	...
	public static int REPORT_ROW_PER_PAGE = 100;
	public static String ROLE_CASHIER = "Kasir";
	...
	public static String MENU_REPORT_MENU_TERJUAL_NAME = "REPORT MENU TERJUAL";
}
